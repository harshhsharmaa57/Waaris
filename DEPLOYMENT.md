...
1. Docker Compose runs PostgreSQL, Redis, NATS, service containers, and optional observability locally.
...
2026-07-11 — initial deployment plan; no environments provisioned.
